"""service_provider_27570 URL Configuration
...
admin.site.site_header = "service provider"
admin.site.site_title = "service provider Admin Portal"
admin.site.index_title = "service provider Admin"
